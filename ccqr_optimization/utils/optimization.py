...
class DecayingSearcherOptimizer:
    """Searcher optimizer with time-based decay of tuning interval.

    Args:
        n_tuning_episodes (int): Tuning episodes per step. Defaults to 10.
        initial_tuning_interval (int): Initial interval. Defaults to 1.
        conformal_retraining_frequency (int): Retraining frequency baseline. Defaults to 1.
        decay_rate (float): Decay rate parameter. Defaults to 0.1.
        decay_type (str): One of 'linear', 'exponential', or 'logarithmic'. Defaults to 'linear'.
        max_tuning_interval (int): Maximum interval cap. Defaults to 20.
    """
...
class FixedSearcherOptimizer:
    ...
    Args:
        n_tuning_episodes (int): Tuning episodes per step. Defaults to 10.
        tuning_interval (int): Fixed interval. Defaults to 5.
        conformal_retraining_frequency (int): Retraining frequency baseline. Defaults to 1.
    """
    ...
    def update(self, search_iter: Optional[int] = None) -> None:
        """Update method for API compatibility (no-op for fixed optimizer).
