...
class ProgressBarManager:
    """Manages progress bar for search operations."""
    ...
    def create_progress_bar(
        ...
        """Initialize a progress bar based on runtime or iteration constraints.

        Args:
            max_runtime: Maximum runtime in seconds.
            max_searches: Maximum number of iterations.
            current_trials: Number of completed trials.
    ...
    def update_progress(
        ...
        """Update progress bar based on runtime or iteration increments.

        Args:
            current_runtime: Current elapsed runtime in seconds.
            iteration_count: Number of iterations to increment.
        """
...
class Study:
    """Aggregates and manages experiment trials."""
    ...
    def append_trial(self, trial: Trial):
        """Append a trial to the study log.
    ...
    def batch_append_trials(self, trials: list[Trial]):
        """Append multiple trials to the study log.
    ...
    def get_searched_configurations(self) -> list[dict]:
        """Return all configurations evaluated in the study.
    ...
    def get_searched_performances(self) -> list[dict]:
        """Return all performance values from the study.
    ...
    def get_best_configuration(self) -> dict:
        """Return the best configuration according to optimization direction.
    ...
    def get_best_performance(self) -> float:
        """Return the best performance value according to optimization direction.
    ...
    def get_average_target_model_runtime(self) -> float:
        """Return average target model runtime across all trials.
...
class BaseConfigurationManager:
    """Abstract base for configuration management in search workflows."""
    ...
    def _setup_encoder(self) -> None:
        """Initialize the configuration encoder."""
    ...
    def mark_as_searched(self, config: dict, performance: float) -> None:
        """Mark configuration as searched and record performance.
    ...
    def tabularize_configs(self, configs: list[dict]) -> np.array:
        """Convert configuration dictionaries to tabular array.
    ...
    def listify_configs(self, configs: list[dict]) -> list[list[float]]:
        """Convert configuration dictionaries to lists of numerical values.

        Args:
            configs: List of configuration dictionaries.
        Returns:
            List of lists with numerical values.
        """
        if not configs:
            return []
    ...
    def add_to_banned_configurations(self, config: dict) -> None:
        """Add configuration to banned list.
