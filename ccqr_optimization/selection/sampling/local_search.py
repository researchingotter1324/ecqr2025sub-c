...
class LocalSearchOptimizer:
    ...
    def __init__(
        ...
        config_manager,
        metric_sign: int = 1,
        n_historical_epicenters: int = 3,
        n_acq_epicenters: int = 50,
        min_epicenter_dist: float = 0.1,
        w_historical: float = 0.7,
        w_acq: float = 0.3,
        n_perturbations: int = 50,
        initial_perturbation_scale: float = 0.1,
        scale_growth_factor: float = 1.1,
        max_perturbation_scale: float = 10.0,
        tolerance_max: int = 100,
        max_surrogate_calls: int = 50000,
