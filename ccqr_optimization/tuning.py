...
import inspect
from ccqr_optimization.utils.tracking import (
    Trial,
    Study,
    RuntimeTracker,
...
from ccqr_optimization.utils.optimization import FixedSearcherOptimizer, DecayingSearcherOptimizer
...
class ConformalTuner:
    """Hyperparameter optimization using conformal prediction surrogates.

    Implements a hyperparameter optimization system that combines random search
    initialization with conformal prediction-guided exploration. The tuner uses uncertainty
    quantification to inform decisions about which configurations to evaluate next.
    ...
    def tune(
        ...
        Example:
            Basic usage::
                ...
                from ccqr_optimization.wrapping import IntRange, FloatRange
